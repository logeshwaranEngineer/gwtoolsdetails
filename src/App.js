...
//   const [user, setUser] = useState(null); // boss, admin, supervisor
...
// )}
//   if (showChangePass) {
//     return <ChangePassword role={user} onBack={() => setShowChangePass(false)} />;
//   }

//   return (
//     <div className="app-container">
//       <Navbar activeTab={activeTab} setActiveTab={setActiveTab} />
//       <p className="login-info">Logged in as: {user.toUpperCase()}</p>
//       <button className="nav-btn" onClick={() => setShowChangePass(true)}>
//         Change Password
//       </button>
//       <button className="nav-btn" onClick={() => setUser(null)}>
//         Logout
//       </button>
